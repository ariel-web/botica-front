<template>
  <div class="wrapper">
    <div class="container">
      <div v-if="props.imagen  != null " class="top" @click="card = true" style="cursor:pointer; display:flex; justify-content:center;">
        <img :src="props.foto" height="160" alt=""  />
      </div>

      <div v-else class="top" @click="card = true" style="cursor:pointer; display:flex; justify-content:center; ">
        <img src="../../assets/imagenes/businessman.png" height="180" alt=""  />
      </div>
      <div class="bottom">
        <div class="left">
          <div class="details">
  ...
  <q-dialog v-model="card">
    <q-card class="my-card">
      <div v-if="props.imagen == null">
        <q-img src="../../assets/imagenes/perfil2.jpg"/>
      </div>
      <div v-else>
        <q-img :src="props.foto" />
      </div>
      ...
      <q-card-section>
        ...
        <div class="row no-wrap items-center">
          <div class="col text-h6 ellipsis">
            {{ props.nombre }} {{props.apellidos}} - <span> {{ props.rol == 1 ? "Admin": "Usuario" }} </span>
          </div>
        </div>
      </q-card-section>
