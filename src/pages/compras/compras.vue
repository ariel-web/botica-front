<template>
  ...
  <q-drawer
    ...
    :width="320"
    :breakpoint="500"
    style="position:relative; background:white; box-shadow: rgba(0, 0, 0, 0.05) 0px 0px 0px 1px; padding-bottom:70px;"
  >

  <div style="margin:15px;">
    <div style="margin-top:0px; margin-bottom: 10px; display:flex; justify-content:center;">
      <span style="text-align:center; font-weight: 400; font-size: 1.2rem;">Tus Compras</span>
    </div>
    <CestaCompras/>
  </div>

  <div style="position:fixed; width:100%; height: 110px; background:white; bottom:0px;" >
    <FooterSlider/>
  </div>
