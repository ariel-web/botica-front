<template>
        ...
        <q-tr :props="props" style="border: 3px solid red !important">
          ...
          <q-td key="nombre" :props="props" style="width: 50px">
            <span style="font-size: 0.8rem">
              {{ props.row.nombre }} {{ props.row.apellidos }}</span
            >
          </q-td>
          ...
          <q-td key="rol" :props="props" width="50px">
            <span style="font-size: 0.8rem">{{
              props.row.rol == 0 ? "Usuario" : "Administrador"
            }}</span>
          </q-td>

          <q-td key="estado" :props="props" style="width: 50px">
            <div
              v-if="props.row.estado != props.row.estadoItem"
              style="display: none"
            >
  ...
  <q-dialog v-model="modalAgregar" full-width>
    <div>
      <form
          ...
          <div style="display: flex; background: white">
            ...
            >
              <div
                ...
                "
              >
                <span style="font-weight: 500; color: white; font-size: 1.3rem"
                  >&nbsp;</span
                >
              </div>
              <!-- input  file -->
              ...
              <!-- end input file -->
              <span style="color: white; margin-botttom: 3px"
                >Cargo: {{ cargo }}</span
              >
              <q-input
                color="negative"
            ...
            <div style="width: 700px; background: white">
              <div style="padding: 20px">
                ...
                >
                  <span
                    style="font-weight: 700; color: black; font-size: 1.3rem"
                    >Datos del Empleado</span
                  >
                ...
                <div style="width: 100%; display: flex">
                  <div
                    style="width: 50%; padding-right: 20px; padding-top: 10px"
                  >
                    <span style="color: black; margin-bottom: 15px"
                      >Nombres: {{ nombres }}
                    </span>
                    <q-input
                      color="negative"
                  ...
                  <div
                    style="width: 50%; padding-top: 10px; padding-left: 10px"
                  >
                    <span style="color: black; margin-bottom: 15px"
                      >Apellidos: {{ apellidos }}</span
                    >
                    <q-input
                      color="negative"
                      dense
                ...
                <div style="width: 100%; display: flex">
                  ...
                  >
                    <span style="color: black; margin-bottom: 15px"
                      >Celular Familiar: {{ numeroFamiliar }}</span
                    >
                    <q-input
                      color="negative"
                      mask="###-###-###"
                    ...
                    <button class="buttonUsuario" type="submit">
                      Registrar
                    </button>
                  </div>
                </div>
...
export default {
  ...
  methods: {
    ...
    ObtenerSucursales() {
      ...
      axios
        .get("http://localhost:8000/admin/sucursales", config)
        .then((response) => {
    ...
    ObtenerUsuarios() {
      ...
      axios
        .get("http://localhost:8000/admin/usuarios", config)
        .then((response) => {
          let len = response.data.length;
          console.log(len);
          if (len >= 0) {
    ...
    EliminarUsuario(id) {
      ...
      axios
        .delete(`http://localhost:8000/admin/usuarios/${id}`, config)
        .then((response) => {
